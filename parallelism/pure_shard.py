...
from graduation.utils import set_seed, parse_args, generate_llama_config, print_model_and_size
...
def train(args):
    ...
    print_model_and_size(llama_model)
    ...
    sampler = DistributedBatchSampler(dataset, batch_size=local_batch_size, num_replicas=args.dp_degree, rank=hcg.get_data_parallel_rank(), shuffle=True) 
